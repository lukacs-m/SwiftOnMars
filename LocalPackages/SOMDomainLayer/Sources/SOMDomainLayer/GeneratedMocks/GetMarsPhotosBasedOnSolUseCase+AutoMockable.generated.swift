...
public final class GetMarsPhotosBasedOnSolUseCaseMock: @unchecked Sendable, GetMarsPhotosBasedOnSolUseCase {
   ...
   public var executeForAtForAndCalled: Bool {
    ...
    public var executeForAtForAndReceivedArguments: (roverId: RoverIdentification, sol: Int, camera: String?, page: Int?)?
    public var executeForAtForAndReceivedInvocations: [(roverId: RoverIdentification, sol: Int, camera: String?, page: Int?)] = []
   ...
   public func execute(for roverId: RoverIdentification, at sol: Int, for camera: String?, and page: Int?) throws -> [Photo] {
        ...
        return try executeForAtForAndClosure.map({ try $0(roverId, sol, camera, page) }) ?? executeForAtForAndReturnValue
    }
